...
if (isset($_POST['post!'])) {
    if (!empty($_FILES["image_url"]["name"])) {
        ...
        $image_path = "/var/www/html/image-uploads/" . $filename; // Adjust path as needed
        ...
        if (move_uploaded_file($image_tmp, $image_path)) {
            ...
            $stmt = $db->prepare("INSERT INTO posts (user_id, caption, image_path, likes, comments, time_stamp) VALUES (?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("issiis", $user_id, $caption, $image_path, $likes, $comments, $time_stamp);
